...
Если вы используете репозиторий как многомодульный проект, вам потребуется настроить рабочую директорию модуля, для того чтобы файл со списком сотрудников был доступен по указанному в пути коду: Настройка рабочей директории проекта в IDEA
